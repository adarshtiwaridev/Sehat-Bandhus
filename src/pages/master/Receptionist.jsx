// components/ReceptionistLayout.jsx or components/ReceptionistLayout.tsx
...
const RECEPTIONIST_NAME = "Ms. Sarah Connor";
const RECEPTIONIST_IMAGE_PATH = "/assets/img/receptionist/user-thumb-02.jpg"; // Placeholder path
...
const handleLogout = () => {
    ...
    console.log("Receptionist Logout button clicked");
};
...
const ReceptionistLayout = ({ children, headContent }) => {
    return (
        <div id="receptionist-master-page">
            <Head>
                <title>Doccure</title>
                
                {/* ASP:ContentPlaceHolder ID="ContentPlaceHolder2" & ID="head" */}
                {headContent} 
                ...
                {/* NOTE: CSS links are omitted as Tailwind replaces them. 
                    Ensure Font Awesome and Select2 are correctly configured. 
                */}
            ...
            <div className="main-wrapper flex flex-col min-h-screen">
                                    ...
                                    <li className="nav-item dropdown has-arrow logged-item relative group ml-3">
                                        <a href="#" className="dropdown-toggle nav-link p-0 block" data-bs-toggle="dropdown">
                                            <span className="user-img">
                                                {/* DoctorImage0 (used as a generic user image here) */}
                                                <Image src={RECEPTIONIST_IMAGE_PATH} alt="Receptionist" className="rounded-full object-cover" width={31} height={31}/>
                                            </span>
                                        </a>
                                        <div className="dropdown-menu dropdown-menu-end absolute right-0 mt-2 w-56 bg-white shadow-xl rounded-md overflow-hidden hidden group-hover:block z-10">
                                            <div className="user-header p-4 border-b border-gray-100 flex items-center">
                                                <div className="avatar avatar-sm mr-3">
                                                    {/* DoctorImage1 (larger image) */}
                                                    <Image src={RECEPTIONIST_IMAGE_PATH} alt="User Image" className="avatar-img rounded-full object-cover" width={40} height={40}/>
                                                </div>
                                                <div className="user-text">
                                                    {/* lblName */}
                                                    <h6 className="font-semibold text-gray-800">{RECEPTIONIST_NAME}</h6>
                                                </div>
                                            </div>
                                            <Link href="../Doctor/Dashboard.aspx" className="dropdown-item block px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors">
                                                Dashboard {/* Assuming Receptionist uses a dashboard similar to Doctor */}
                                            </Link>
                                            {/* profileNaviagte */}
                                            <Link href="../Receptionist/Profile.aspx" className="dropdown-item block px-4 py-2 text-gray-700 hover:bg-gray-100 transition-colors">
                                                Profile
                                            </Link>
                                            {/* LogOut Button */}
                                            <button 
                ...
                {/* ContentPlaceHolder1 (Main Content) */}
                <main className="flex-grow pt-20"> 
                    {children}
                </main>
                
                {/* Footer Section - Same structure as previous layouts */}
